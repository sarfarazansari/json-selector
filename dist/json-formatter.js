 ...
 * jsonformatter
 * 
 * Version: 0.6.0 - 2016-07-15T12:15:10.614Z
 * License: Apache-2.0
 */
...
.service('$jsonFormatter', [function() {
  ...
  return {
    select: function(expression) {
      broadcastEvent('element.select', expression);
    },
    deselect: function(expression) {
      broadcastEvent('element.deselect', expression);
    },
